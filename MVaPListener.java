...
public interface MVaPListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link MVaPParser#calcul}.
	 * @param ctx the parse tree
	 */
	void enterCalcul(MVaPParser.CalculContext ctx);
	/**
	 * Exit a parse tree produced by {@link MVaPParser#calcul}.
	 * @param ctx the parse tree
	 */
	void exitCalcul(MVaPParser.CalculContext ctx);
	/**
	 * Enter a parse tree produced by {@link MVaPParser#instruction}.
	 * @param ctx the parse tree
	 */
	void enterInstruction(MVaPParser.InstructionContext ctx);
	/**
	 * Exit a parse tree produced by {@link MVaPParser#instruction}.
	 * @param ctx the parse tree
	 */
	void exitInstruction(MVaPParser.InstructionContext ctx);
	/**
	 * Enter a parse tree produced by {@link MVaPParser#expression}.
	 * @param ctx the parse tree
	 */
	void enterExpression(MVaPParser.ExpressionContext ctx);
	/**
	 * Exit a parse tree produced by {@link MVaPParser#expression}.
	 * @param ctx the parse tree
	 */
	void exitExpression(MVaPParser.ExpressionContext ctx);
	/**
	 * Enter a parse tree produced by {@link MVaPParser#finInstruction}.
	 * @param ctx the parse tree
	 */
	void enterFinInstruction(MVaPParser.FinInstructionContext ctx);
	/**
	 * Exit a parse tree produced by {@link MVaPParser#finInstruction}.
	 * @param ctx the parse tree
	 */
	void exitFinInstruction(MVaPParser.FinInstructionContext ctx);
}